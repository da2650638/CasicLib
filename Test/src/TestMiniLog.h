...
inline void testMiniLog()
{
	...
	casic::minilog::log_trace("trace log");
	casic::minilog::log_debug("debug log");
	casic::minilog::log_info("info log");
	casic::minilog::log_warning("warning log");
	casic::minilog::log_error("error log");
	casic::minilog::log_fatal("fatal log");
}